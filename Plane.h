...
namespace Airline {
    ...
    public:
        ...
        Plane(string newIdentifier); // constructor that sets the dimensions of the plane and the plane identifier
...
//        int getRows() const; // gets the number of rows
        ...
        void setEconColumns(int const & newEconColumns);
        int getEconColumns() const;
        void setEconPlusColumns(int const & newEconPlusColumns);
        int getEconPlusColumns() const;
        void setFirstClassColumns(int const & newFirstClassColumns);
        int getFirstClassColumns() const;
